...
public class employee {
	public static void main(String args[]){
		...
		al.add(new Employee1(101,"Vijay",5000,23));
		al.add(new Employee1(106,"Ajay",6000,27));
		al.add(new Employee1(105,"Jai",7000,21));
		al.add(new Employee1(102,"Aditya",8000,23));
		al.add(new Employee1(103,"Pandey",9000,27));
		al.add(new Employee1(104,"Nitish",2200,21));
		al.add(new Employee1(107,"Rohit",6600,23));
		al.add(new Employee1(108,"Yaasen",8900,27));
		al.add(new Employee1(109,"Shiva",9000,21));
		al.add(new Employee1(110,"Divas",8700,23));
